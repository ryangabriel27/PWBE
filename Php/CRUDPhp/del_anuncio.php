    ...
    <div class="container">
        ...
        <form action="processa_anuncio.php" method="POST">
            ...
            <div class="col-4">
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" name="sexo" value="F" id="sexoF" <?php echo $result['sexo'] == 'F' ? "checked" : "disabled" ?><label for="sexoF" class="form-check-label">Fêmea</label>
                </div>
            </div>
            <div class="col-4">
